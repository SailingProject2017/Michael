...
public class DepthRender : BaseObject {
    ...
    private void ClucDepth()
    {
        ...
        switch (Singleton<GameParam>.instance.Depth.ToString().Length)
        {
            case 1:
                // 1桁目を表示
                ChangeSprite(Singleton<GameParam>.instance.Depth, 1);
                break;

            case 2:
                // 2桁目を表示
                ChangeSprite(Singleton<GameParam>.instance.Depth / 10, 2);
                depth = Singleton<GameParam>.instance.Depth % 10;
            ...
            case 3:
                // 3桁目を表示
                ChangeSprite(Singleton<GameParam>.instance.Depth / 100, 3);
                depth = Singleton<GameParam>.instance.Depth % 100;
            ...
            case 4:
                // 4桁目を表示
                ChangeSprite(Singleton<GameParam>.instance.Depth / 1000, 4);
                depth = Singleton<GameParam>.instance.Depth % 1000;
